...
const titleFromPath = (pathname) => {
  ...
  if (pathname.startsWith("/doctor-management")) return "Doctors";
  if (pathname.startsWith("/Admin-management")) return "Admins";
  if (pathname.startsWith("/Admin/verify-email")) return "Verify Email";
  if (pathname.startsWith("/Admin/change-password")) return "Change Password";
  return "Admin Portal";
};

const subtitleFromPath = (pathname) => {
  if (pathname === "/") return "Overview of your telemedicine activity";
  if (pathname.startsWith("/doctor-management"))
    return "Manage all Doctors on  platforms";
  if (pathname.startsWith("/patient-management"))
    return "Manage all patient on the platform";
